...
public class VoiceDetectionService extends VoiceInteractionService {
    ...
    public void onReady() {
        ...
        mHotwordDetector = createAlwaysOnHotwordDetector(
                "Hi", Locale.forLanguageTag("en-US"), mHotwordCallback);
    }
        ...
        switch (availability) {
            ...
            case AlwaysOnHotwordDetector.STATE_KEYPHRASE_ENROLLED:
                ...
                if (mHotwordDetector.startRecognition(
                    ...
                    Intent speechInput = new Intent(VoiceDetectionService.this, SpeechInput.class);
