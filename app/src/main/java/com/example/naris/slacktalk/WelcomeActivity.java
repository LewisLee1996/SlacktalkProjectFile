...
public class WelcomeActivity extends AppCompatActivity {
    ...
    SharedPreferences nightModePrefs,notificationPrefs,voiceControlSystemPrefs;
    ...
    public void first_time_setting(){
        nightModePrefs = this.getSharedPreferences("nightModeSetting",0);
        notificationPrefs = this.getSharedPreferences("notificationSetting", 0);
        voiceControlSystemPrefs = this.getSharedPreferences("voiceControlSystemSetting", 0);
    ...
    private void launchHomeScreen() {
        if (!isDefaultSmsApp(this)) {
            startActivity(new Intent(WelcomeActivity.this, SetDefaultActivity.class));
            finish();
        }
        else {
            if (haveAllPermissions()) {
                ...
                startActivity(new Intent(WelcomeActivity.this, getPermissionActivity.class));
                finish();
            }
        }
    }
